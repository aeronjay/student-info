  ...
  return (
    <View className="flex-1 bg-white dark:bg-gray-900 px-6 pt-12">
      ...
      <View className="items-center mb-8">
        ...
        <Text className="text-base text-gray-500 dark:text-gray-400">{user?.role ? user.role.charAt(0).toUpperCase() + user.role.slice(1) : 'Student'}</Text>
        <Text className="text-base text-gray-700 dark:text-gray-300">{user?.email || 'student@email.com'}</Text>
      </View>
      {/* Settings Sections */}
      <SettingSection
